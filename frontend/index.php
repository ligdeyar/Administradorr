...
<body class="menu">
    <main>
    <a href="logout.php" ><i  class="fas fa-power-off" style="color: #F7B718;"></i></a>
        <div class="contenido-menu">
        <img src="img/iconos/logo_rojo.png" alt=""  class=" icono" >
            <div class="container">
                <div class="row">
            ...
            <div class="container ">
                ...
                <div class="row ">
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            <img src="img/Administrar_empresas.png" width="200" height="200">
                        </div>
                    </div>
                </div>
            </div>
